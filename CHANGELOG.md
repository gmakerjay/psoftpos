...
### 🖨️ 2. แก้ไขปัญหาตั้งค่าเครื่องพิมพ์ไม่จำค่าและภาษาเพี้ยน (Printer Settings Persistence & GDI Auto-Recommend Fix)
...
* **จุดที่ทำการแก้ไข:**
  ...
  * **หน้าบ้าน:** ย้ายระบบป้องกันตัวหนังสือเพี้ยนของตระกูล XP-58 มาทำที่หน้าต่าง Settings โดยใช้ระบบดักจับ (Trace) บนหน้าจอของเครื่องพิมพ์ หากพบชื่อเครื่องพิมพ์เป็น `"XP-58"` ระบบจะทำการพรีเซ็ตแนะนำตัวเลือกเป็น `"windows"` (GDI) และขนาดกระดาษ `"58mm"` ให้ผู้ใช้เห็นบนหน้าจอด้านหน้าทันที เพื่อความสะดวกและปลอดภัยต่อผู้ใช้ แต่เปิดช่องให้สามารถบันทึกและจำค่าโหมดอื่นๆ ได้ตามใจชอบโดยไม่มีการแทรกแซงเบื้องหลัง
